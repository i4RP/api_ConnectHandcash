...
type PathWithVariable<Prefix extends string, Variable extends string, Suffix extends string> = `${Prefix}/${Variable}${Suffix}`;
type ListResponse<T> = {
    items: T[];
};
export type CloudResponse = {
    ...
    '/v1/connect/account/requestEmailCode': {
        requestId: {
            requestId: string;
        };
    };
    ...
    '/v1/connect/runExtension/purse/pay': {
    ...
    '/v1/connect/runExtension/owner/sign': {
        signedTransaction: string;
    };
    '/v1/connect/runExtension/owner/nftLocations': {
        nftLocations: string[];
    };
